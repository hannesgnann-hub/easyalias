...
import {
  dismissCommandFileImport,
  importSelectedCommandFiles,
  openCommandFileImport
} from "./aliases/commandFileImport";
...
import { closeManualImport } from "./aliases/shellImport";
import {
  closeTrash,
  emptyTrash,
  openTrash,
