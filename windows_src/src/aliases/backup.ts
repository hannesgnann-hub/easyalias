    ...
    <section class="modal-layer" role="presentation">
      ...
      >
        ...
        ${
          isExport
            ? ""
            : `<button class="backup-drop-zone" type="button" data-action="choose-backup-file" ${state.backupBusy ? "disabled" : ""}>
                    ...
                    return `
                      <label class="import-row">
                        <input
                          ...
                          ${state.selectedBackupIds.has(alias.id) ? "checked" : ""}
        ...
        <div class="modal-actions import-actions">
          ...
          <button class="primary-button" type="submit" data-backup-submit ${state.selectedBackupIds.size && !state.backupBusy ? "" : "disabled"}>
            ${state.backupBusy ? "Working..." : `${isExport ? "Export" : "Import"} Selected (${state.selectedBackupIds.size})`}
          </button>
        </div>
      </form>
    </section>
