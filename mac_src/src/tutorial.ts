  ...
  aliases: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: `
          <p>EasyAlias writes <code>~/.easyalias/aliases.zsh</code> and adds <code>source ~/.easyalias/aliases.zsh</code> to your <code>~/.zshrc</code> once.</p>
          <p>A <strong>new</strong> terminal window has your aliases right away. In a terminal that's already open, run <code>source ~/.zshrc</code> to pick up changes.</p>`
      }
    ]
  },
  automations: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: `
          ...
          <p>Optionally limit it to certain weekdays. EasyAlias hands the schedule to macOS <code>launchd</code>, so it fires <strong>even when EasyAlias is closed</strong>. The card shows the last run's result.</p>`,
        image: tutorialScheduleImg
      },
      {
        title: "Keyboard shortcut",
        body: `
          <p>The <strong>keyboard</strong> icon on a card records a global shortcut (for example <kbd>&#8984;</kbd><kbd>&#8679;</kbd><kbd>L</kbd>). While EasyAlias runs, pressing it anywhere fires that automation.</p>
          ...
          <p>Closing the window keeps EasyAlias in the <strong>menu bar</strong> so shortcuts and schedules keep working; quit it from the menu-bar icon.</p>`,
